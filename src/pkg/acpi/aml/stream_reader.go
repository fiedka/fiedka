...
var (
	errInvalidUnreadByte = fmt.Errorf("bad call to UnreadByte; stream offset is 0")
	errInvalidPkgEnd     = fmt.Errorf("attempted to set pkgEnd past the end of the stream")
	errReadPastPkgEnd    = fmt.Errorf("attempted to read past pkgEnd")
)
